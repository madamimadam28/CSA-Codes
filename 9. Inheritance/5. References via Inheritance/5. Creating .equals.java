/* For this exercise, we are going to look at how we can create a .equals method. Remember, to compare objects, we cannot just use ==. 
We need to create a criteria to determine if the objects are equal.

In our case, we will say that two people are the same if both the name and birthday match. 
We are going to write a program that prompts the user for a person’s name and birthday and a student’s name, birthday, and grade, and decide if they are the same person.
...
public class Person {
    ...
    public boolean equals(Person p) {
        return p.getName().equals(this.getName()) && p.getBirthday().equals(this.getBirthday());
    }
}
...
public class PersonTester
{
    ...
    {
        // Start here!
        Person p1 = new Person("Tanner", "1/1/2000");
        Person p2 = new Student("Tanner", "1/1/2000", 12);
